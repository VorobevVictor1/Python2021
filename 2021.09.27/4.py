...
rect(screen, (0, 255, 255), (0, 0, 1000, 300))
rect(screen, (0, 0, 0), (0, 300, 1000, 10))
...
for i in range(1,11,1):
    pictureofbear(randint(0,800),randint(400,800),randint(1,20)/20)
    pictureoffish(randint(200,800),randint(400,800),randint(1,20)/30)
